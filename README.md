...
City Management System is a custom made react application for simple use case of showing a list of Cities and their images. The backend of the system
must be configured at the .env file level.
...
2. Run the Backend Spring boot application (localhost:8084)
2. Follow the terminal command mentioned below.
